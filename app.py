...
# -------------------------------------------------------
# NEW SECTION — Market Intelligence & Strategy
# -------------------------------------------------------
st.markdown("<div class='section-label'>Market Intelligence & Strategy</div>", unsafe_allow_html=True)
st.header("Competitive & Strategic Mapping Tools")
...
with col:
    render_card(
        ...
        "LLM‑powered market mapping revealing strategic positioning and white‑space opportunities",
        "Transforms raw brand names into a 2D strategic map using LLM‑generated attributes, PCA/MDS dimensionality reduction, and automated insight generation.",
        ["LLMs", "PCA", "MDS", "Competitive Intelligence"],
